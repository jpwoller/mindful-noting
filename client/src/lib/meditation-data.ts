 ...
 * 
 * All audio files are in public/audio/ and served relative to the Vite base path.
 * This ensures compatibility with GitHub Pages subdirectory deploys.
 */
...
export interface Waypoint {
  ...
  title: string;
  text: string;
  audioFile: string; // filename only, resolved at runtime with base path
  audioDuration: number; // seconds
}

/**
 * Resolve an audio file path using the Vite base URL.
 * This handles GitHub Pages subdirectory deploys (e.g., /mindful-noting/audio/file.mp3)
 */
export function getAudioUrl(filename: string): string {
  const base = import.meta.env.BASE_URL || "/";
  // Ensure base ends with / and no double slashes
  const normalizedBase = base.endsWith("/") ? base : base + "/";
  return `${normalizedBase}audio/${filename}`;
}

/** Background binaural meditation music filename */
export const BINAURAL_MUSIC_FILE = "binaural-loop.mp3";
...
export const waypoints: Waypoint[] = [
  {
    ...
    audioFile: "waypoint_00_hindrances_intro.mp3",
    audioDuration: 42.0,
  },
  {
    id: 1,
    ...
    audioFile: "waypoint_01_opening.mp3",
    audioDuration: 15.5,
  },
  {
    id: 2,
    ...
    audioFile: "waypoint_02_anchoring.mp3",
    audioDuration: 13.8,
  },
  {
    id: 3,
    ...
    audioFile: "waypoint_03_noting_thoughts.mp3",
    audioDuration: 23.0,
  },
  {
    id: 4,
    ...
    audioFile: "waypoint_04_refining.mp3",
    audioDuration: 16.7,
  },
  {
    id: 5,
    ...
    audioFile: "waypoint_05_judgments.mp3",
    audioDuration: 17.1,
  },
  {
    id: 6,
    ...
    audioFile: "waypoint_06_sensations.mp3",
    audioDuration: 24.95,
  },
  {
    id: 7,
    ...
    audioFile: "waypoint_07_hindrances.mp3",
    audioDuration: 12.85,
  },
  {
    id: 8,
    ...
    audioFile: "waypoint_08_moods.mp3",
    audioDuration: 13.95,
  },
  {
    id: 9,
    ...
    audioFile: "waypoint_09_letting_go.mp3",
    audioDuration: 11.9,
  },
  {
    id: 10,
    ...
    audioFile: "waypoint_10_closing.mp3",
    audioDuration: 9.7,
  },
];
